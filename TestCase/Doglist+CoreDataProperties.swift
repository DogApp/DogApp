...
extension Doglist {
    ...
    @NSManaged public var dogAge: Int
    @NSManaged public var dogName: String
    @NSManaged public var dogPicture: NSObject?
    @NSManaged public var dogWeight: Float
    @NSManaged public var vac_1: Bool
    @NSManaged public var vac_2: Bool
    @NSManaged public var vac_3: Bool
    
    func setval(Name:String, Age:Int, Weight:Float){
        self.dogName = Name
        self.dogAge = Int(Age)
